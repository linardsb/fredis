...
- **HABITS.md daily reset broken since at least 2026-04-25, ~14-day drift confirmed 2026-05-10.** First flagged 2026-04-25 (header stuck at 2026-04-24). 17:01 heartbeat on 2026-05-10 confirmed the header still reads "Today: 2026-04-26" against actual date 2026-05-10 — the reset hasn't fired for roughly two weeks, all five pillars permanently 0/5. Impact upgraded from low → med: the Ship-pillar signal and 18:00 self-report fallback are both nullified by a stale header. Investigate the timer/cron that owns the reset (likely a missing systemd unit or a guard inside `heartbeat.py`/a sibling script). `[impact: med, status: pending]`
...
- **`input_tokens` metric semantics need verification on resumed SDK sessions (2026-05-04).** Determines whether Phase A's token-tracking approach in `thread-consolidation-canon-handoff.md` is viable as designed. Open question: does `input_tokens` on a resumed SDK session include carry-forward context, or just the new turn's input? Investigation interrupted mid-session. `[impact: med, status: pending]`
- **Guardrail false-positive on `</external_data>` closing tag — now blocking reflection AND synthesis (2026-04-28, escalated 2026-04-30, re-escalated 2026-05-03, re-escalated 2026-05-04, re-escalated 2026-05-06, re-escalated 2026-05-08, re-escalated 2026-05-10).** Every non-timeout heartbeat on 2026-04-28 (7/7), 2026-04-30 (8/8), 2026-05-02 (9/9), 2026-05-04 (8/8 non-timeout), 2026-05-06 (7/7 non-timeout), 2026-05-08 (9/9), and 2026-05-10 (8/8) flagged the legitimate structural closing tag of the data wrapper as `xml_escape_attempt`. The 2026-04-30, 2026-05-02, 2026-05-04, 2026-05-06, 2026-05-08, and 2026-05-10 reflection passes all aborted (`reflection-aborted` source) — losing six days of MEMORY.md consolidation. **Synthesis escalation 2026-05-03:** weekly synthesis pass also aborted (`synthesis-aborted` source) at 08:00 because the same pattern was detected in the daily-log bundle — now blocking the Sunday Dream-loop too. Synthesis aborted again 2026-05-10. Two of the four memory loops (Consolidate + Dream) are silently skipping due to a single false-positive pattern. Pattern matcher needs to either skip the wrapper's own structural tags or only fire when the tag appears *inside* an inner content block. `[impact: high, status: pending]`
...
_Older entries archived: [2026-04](archive/2026-04.md), [2026-05](archive/2026-05.md) — searchable via memory_search._
