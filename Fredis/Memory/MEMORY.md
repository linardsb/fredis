...
- **Heartbeat guardrail fail-closed eleven times: 2026-04-24 05:54 + 10:05, 2026-04-25 16:06, 2026-04-26 08:10 + 19:41, 2026-04-27 08:18 + 16:22, 2026-04-28 17:00, 2026-04-29 06:35, 2026-05-04 11:16 + 15:17.** First two were pre-Sonnet-promotion (commit `5069d4e`); the remaining nine are **post-promotion**, so the Haiku→Sonnet move did not fully resolve it. Pace is now ~daily, not weekly. Next action: raise `asyncio.wait_for` from 15s to 30s in `heartbeat.py` and/or add single-retry before failing closed. `[impact: med, status: pending]`
...
- **Guardrail false-positive on `</external_data>` closing tag — now blocking reflection AND synthesis (2026-04-28, escalated 2026-04-30, re-escalated 2026-05-03, re-escalated 2026-05-04).** Every non-timeout heartbeat on 2026-04-28 (7/7), 2026-04-30 (8/8), 2026-05-02 (9/9), and 2026-05-04 (8/8 non-timeout) flagged the legitimate structural closing tag of the data wrapper as `xml_escape_attempt`. The 2026-04-30, 2026-05-02, and 2026-05-04 reflection passes all aborted (`reflection-aborted` source) — losing three days of MEMORY.md consolidation. **Synthesis escalation 2026-05-03:** weekly synthesis pass also aborted (`synthesis-aborted` source) at 08:00 because the same pattern was detected in the daily-log bundle — now blocking the Sunday Dream-loop too. Two of the four memory loops (Consolidate + Dream) are silently skipping due to a single false-positive pattern. Pattern matcher needs to either skip the wrapper's own structural tags or only fire when the tag appears *inside* an inner content block. `[impact: high, status: pending]`
