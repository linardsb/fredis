# Setup Windows Task Scheduler for Second Brain Daily Reflection
# Run this script as Administrator

$TaskName = "SecondBrain-Reflection"
$TaskPath = Join-Path $PSScriptRoot "run_reflect.bat"
$Description = "Second Brain - Daily memory reflection at 8 AM"
