# Setup Windows Task Scheduler for Second Brain Heartbeat
# Run this script as Administrator

$TaskName = "SecondBrain-Heartbeat"
$TaskPath = Join-Path $PSScriptRoot "run_heartbeat.bat"
$Description = "Second Brain - Proactive heartbeat check every 30 minutes"
