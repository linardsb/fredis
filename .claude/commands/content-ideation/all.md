...
|----------|---------------|---------------|
| YouTube | 3 | `Fredis/Content-Ideation/YouTube/YYYY-MM-DD/` |
| LinkedIn | 5 | `Fredis/Content-Ideation/LinkedIn/YYYY-MM-DD/` |
...
Fredis/Daily Notes/                        ← Note the space
```
...
**2.3** List `Fredis/Daily Notes/` files, sort by name, read the most recent one
...
- `Fredis/Content-Ideation/YouTube/YYYY-MM-DD/`
- `Fredis/Content-Ideation/LinkedIn/YYYY-MM-DD/`
- `Fredis/Content-Ideation/X/YYYY-MM-DD/`
- `Fredis/Content-Ideation/Shorts/YYYY-MM-DD/`
...
- Write to `Fredis/Content-Ideation/YouTube/YYYY-MM-DD/{slug}.md`
- Create index.md
...
- Write to `Fredis/Content-Ideation/LinkedIn/YYYY-MM-DD/{slug}.md`
- Create index.md
...
- Write to `Fredis/Content-Ideation/X/YYYY-MM-DD/{slug}.md`
- Create index.md
...
- Write to `Fredis/Content-Ideation/Shorts/YYYY-MM-DD/{slug}.md`
- Create index.md
...
Create `Fredis/Content-Ideation/YYYY-MM-DD-all.md`:
