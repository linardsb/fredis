...
Get today's date. Create folder: `Fredis/Content-Ideation/LinkedIn/YYYY-MM-DD/`
...
Write each post to `Fredis/Content-Ideation/LinkedIn/YYYY-MM-DD/{slugified-topic}.md`

### 7. Create Index

Create `Fredis/Content-Ideation/LinkedIn/YYYY-MM-DD/index.md`:
...
```
Fredis/Content-Ideation/LinkedIn/2026-01-03/
├── index.md
