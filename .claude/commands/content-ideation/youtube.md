...
Get today's date. Create folder: `Fredis/Content-Ideation/YouTube/YYYY-MM-DD/`
...
Write each script to `Fredis/Content-Ideation/YouTube/YYYY-MM-DD/{slugified-topic}.md`

### 7. Create Index

Create `Fredis/Content-Ideation/YouTube/YYYY-MM-DD/index.md`:
...
```
Fredis/Content-Ideation/YouTube/2026-01-03/
├── index.md
