...
Fredis/Daily Notes/                        ← List files, read most recent (has a space!)
```
...
List `Fredis/Daily Notes/` files (format: `YYYY-MM-DD.md`), sort by name, read the most recent one.
...
Get today's date. Create folder: `Fredis/Content-Ideation/Shorts/YYYY-MM-DD/`
...
Write each Short to `Fredis/Content-Ideation/Shorts/YYYY-MM-DD/{slugified-topic}.md`

### 8. Create Index

Create `Fredis/Content-Ideation/Shorts/YYYY-MM-DD/index.md`:
...
```
Fredis/Content-Ideation/Shorts/2026-01-04/
├── index.md
