# TDD Guide — red-green-refactor across Jest / Pytest / JUnit / Vitest / Mocha


> Ported from [alirezarezvani/claude-skills](https://github.com/alirezarezvani/claude-skills) — `engineering-team/tdd-guide/` — under the MIT License.
> Fredis adaptation: outputs route to `Fredis/Memory/drafts/active/tdd-guide/`; advisor-mode — never auto-send.
...
## Fredis Advisor Mode
Output drafts only. Write to `Fredis/Memory/drafts/active/tdd-guide/YYYY-MM-DD-<slug>.md`. Never:
