# CTO Strategy — technical debt, architecture decisions, engineering metrics, team scaling


> Ported from [alirezarezvani/claude-skills](https://github.com/alirezarezvani/claude-skills) — `c-level-advisor/cto-advisor/` — under the MIT License.
> Fredis adaptation: outputs route to `Fredis/Memory/drafts/active/cto-advisor/`; advisor-mode — never auto-send.
...
## Fredis Advisor Mode
Output drafts only. Write to `Fredis/Memory/drafts/active/cto-advisor/YYYY-MM-DD-<slug>.md`. Never:
