# Product Discovery — opportunity-solution trees, assumption mapping, discovery sprints


> Ported from [alirezarezvani/claude-skills](https://github.com/alirezarezvani/claude-skills) — `product-team/product-discovery/` — under the MIT License.
> Fredis adaptation: outputs route to `Fredis/Memory/drafts/active/product-discovery/`; advisor-mode — never auto-send.
...
## Fredis Advisor Mode
Output drafts only. Write to `Fredis/Memory/drafts/active/product-discovery/YYYY-MM-DD-<slug>.md`. Never:
