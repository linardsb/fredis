# Product Strategy — OKR cascade, quarterly planning, competitive landscape, vision docs


> Ported from [alirezarezvani/claude-skills](https://github.com/alirezarezvani/claude-skills) — `product-team/product-strategist/` — under the MIT License.
> Fredis adaptation: outputs route to `Fredis/Memory/drafts/active/product-strategist/`; advisor-mode — never auto-send.
...
## Fredis Advisor Mode
Output drafts only. Write to `Fredis/Memory/drafts/active/product-strategist/YYYY-MM-DD-<slug>.md`. Never:
