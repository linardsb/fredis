# PM Toolkit — RICE, customer-interview analysis, PRD templates, GTM


> Ported from [alirezarezvani/claude-skills](https://github.com/alirezarezvani/claude-skills) — `product-team/product-manager-toolkit/` — under the MIT License.
> Fredis adaptation: outputs route to `Fredis/Memory/drafts/active/product-manager-toolkit/`; advisor-mode — never auto-send.
...
## Fredis Advisor Mode
Output drafts only. Write to `Fredis/Memory/drafts/active/product-manager-toolkit/YYYY-MM-DD-<slug>.md`. Never:
