# Company OS — operating-system selection (EOS, Scaling Up, OKR-native) + meeting pulse + accountability


> Ported from [alirezarezvani/claude-skills](https://github.com/alirezarezvani/claude-skills) — `c-level-advisor/company-os/` — under the MIT License.
> Fredis adaptation: outputs route to `Fredis/Memory/drafts/active/company-os/`; advisor-mode — never auto-send.
...
## Fredis Advisor Mode
Output drafts only. Write to `Fredis/Memory/drafts/active/company-os/YYYY-MM-DD-<slug>.md`. Never:
