# Strategic Alignment — OKR cascade, orphan-goal detection, silo identification


> Ported from [alirezarezvani/claude-skills](https://github.com/alirezarezvani/claude-skills) — `c-level-advisor/strategic-alignment/` — under the MIT License.
> Fredis adaptation: outputs route to `Fredis/Memory/drafts/active/strategic-alignment/`; advisor-mode — never auto-send.
...
## Fredis Advisor Mode
Output drafts only. Write to `Fredis/Memory/drafts/active/strategic-alignment/YYYY-MM-DD-<slug>.md`. Never:
