...
description: Data science + experimentation — ML modeling (XGBoost, SHAP, MLflow, causal inference / DiD), feature engineering, AUC / PR evaluation, SQL / Pandas / NumPy; hypothesis tests, effect sizes, CIs, Bonferroni, sample-size; A/B experiment design + pre-launch sizing + outcome interpretation; LLM eval harness — judge-based with rubric calibration, fixture-driven regression, online vs offline, failure-mode taxonomies. Use when user says "A/B test", "experiment design", "sample size", "hypothesis test", "confidence interval", "effect size", "statistical significance", "XGBoost", "SHAP", "causal inference", "difference-in-differences", "MLflow", "AUC-ROC", "Scikit-learn", "interpret results", "LLM eval", "judge-based eval", "agent regression test", "eval harness", "LLM-as-judge", "G-Eval", "fixture-driven eval", "eval-as-code".
---
