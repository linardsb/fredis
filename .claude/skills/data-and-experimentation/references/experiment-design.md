# Experiment Design — testable hypotheses, sample-size estimation, A/B interpretation


> Ported from [alirezarezvani/claude-skills](https://github.com/alirezarezvani/claude-skills) — `product-team/experiment-designer/` — under the MIT License.
> Fredis adaptation: outputs route to `Fredis/Memory/drafts/active/experiment-designer/`; advisor-mode — never auto-send.
...
## Fredis Advisor Mode
Output drafts only. Write to `Fredis/Memory/drafts/active/experiment-designer/YYYY-MM-DD-<slug>.md`. Never:
