# Statistical Analysis — hypothesis tests, sample sizing, effect sizes, confidence intervals


> Ported from [alirezarezvani/claude-skills](https://github.com/alirezarezvani/claude-skills) — `engineering/statistical-analyst/` — under the MIT License.
> Fredis adaptation: outputs route to `Fredis/Memory/drafts/active/statistical-analyst/`; advisor-mode — never auto-send.
...
## Fredis Advisor Mode
Output drafts only. Write to `Fredis/Memory/drafts/active/statistical-analyst/YYYY-MM-DD-<slug>.md`. Never:
