# Senior Data Science — statistical modeling, causal inference, XGBoost, SHAP, MLflow, A/B testing


> Ported from [alirezarezvani/claude-skills](https://github.com/alirezarezvani/claude-skills) — `engineering-team/senior-data-scientist/` — under the MIT License.
> Fredis adaptation: outputs route to `Fredis/Memory/drafts/active/senior-data-scientist/`; advisor-mode — never auto-send.
...
## Fredis Advisor Mode
Output drafts only. Write to `Fredis/Memory/drafts/active/senior-data-scientist/YYYY-MM-DD-<slug>.md`. Never:
