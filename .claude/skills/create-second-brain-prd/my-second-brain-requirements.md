...
> Copy this file to your workspace root, fill it out, then run:
> `/create-second-brain-prd <path to this file>`
>
> Your answers feed directly into PRD generation — the more specific, the better your build plan.
...
- **Timezone:** ___
- **Memory vault folder name:** ___ (this is the root folder for all your memory files, e.g. `MyBrain`, `SecondBrain`, or any single word you like)
- **Using Obsidian?** [ ] Yes  [ ] No
