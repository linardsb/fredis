# AI/ML Security — prompt injection, jailbreak, model inversion, data poisoning, MITRE ATLAS


> Ported from [alirezarezvani/claude-skills](https://github.com/alirezarezvani/claude-skills) — `engineering-team/ai-security/` — under the MIT License.
> Fredis adaptation: outputs route to `Fredis/Memory/drafts/active/ai-security/`; advisor-mode — never auto-send.
...
## Fredis Advisor Mode
Output drafts only. Write to `Fredis/Memory/drafts/active/ai-security/YYYY-MM-DD-<slug>.md`. Never:
