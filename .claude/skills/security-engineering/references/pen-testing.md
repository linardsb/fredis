# Pen Testing — OWASP Top 10, dependency + secret scanning, API security, pen-test report generation


> Ported from [alirezarezvani/claude-skills](https://github.com/alirezarezvani/claude-skills) — `engineering-team/security-pen-testing/` — under the MIT License.
> Fredis adaptation: outputs route to `Fredis/Memory/drafts/active/security-pen-testing/`; advisor-mode — never auto-send.
...
## Fredis Advisor Mode
Output drafts only. Write to `Fredis/Memory/drafts/active/security-pen-testing/YYYY-MM-DD-<slug>.md`. Never:
