# Cloud Security — AWS/Azure/GCP posture, IAM escalation paths, S3 exposure, IaC gaps


> Ported from [alirezarezvani/claude-skills](https://github.com/alirezarezvani/claude-skills) — `engineering-team/cloud-security/` — under the MIT License.
> Fredis adaptation: outputs route to `Fredis/Memory/drafts/active/cloud-security/`; advisor-mode — never auto-send.
...
## Fredis Advisor Mode
Output drafts only. Write to `Fredis/Memory/drafts/active/cloud-security/YYYY-MM-DD-<slug>.md`. Never:
