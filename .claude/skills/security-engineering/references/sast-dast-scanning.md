# Senior SecOps — SAST/DAST, CVE remediation, compliance checks (SOC2/PCI-DSS/HIPAA/GDPR)


> Ported from [alirezarezvani/claude-skills](https://github.com/alirezarezvani/claude-skills) — `engineering-team/senior-secops/` — under the MIT License.
> Fredis adaptation: outputs route to `Fredis/Memory/drafts/active/senior-secops/`; advisor-mode — never auto-send.
...
## Fredis Advisor Mode
Output drafts only. Write to `Fredis/Memory/drafts/active/senior-secops/YYYY-MM-DD-<slug>.md`. Never:
