# Scenario War Room — cross-functional what-if modelling for cascading multi-variable risk


> Ported from [alirezarezvani/claude-skills](https://github.com/alirezarezvani/claude-skills) — `c-level-advisor/scenario-war-room/` — under the MIT License.
> Fredis adaptation: outputs route to `Fredis/Memory/drafts/active/scenario-war-room/`; advisor-mode — never auto-send.
...
## Fredis Advisor Mode
Output drafts only. Write to `Fredis/Memory/drafts/active/scenario-war-room/YYYY-MM-DD-<slug>.md`. Never:
