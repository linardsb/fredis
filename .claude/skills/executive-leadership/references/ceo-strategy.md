# CEO Strategy — strategic planning, board prep, investor relations, executive decisions


> Ported from [alirezarezvani/claude-skills](https://github.com/alirezarezvani/claude-skills) — `c-level-advisor/ceo-advisor/` — under the MIT License.
> Fredis adaptation: outputs route to `Fredis/Memory/drafts/active/ceo-advisor/`; advisor-mode — never auto-send.
...
## Fredis Advisor Mode
Output drafts only. Write to `Fredis/Memory/drafts/active/ceo-advisor/YYYY-MM-DD-<slug>.md`. Never:
