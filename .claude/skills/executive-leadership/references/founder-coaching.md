# Founder Coaching — delegation, burnout, imposter syndrome, leadership growth


> Ported from [alirezarezvani/claude-skills](https://github.com/alirezarezvani/claude-skills) — `c-level-advisor/founder-coach/` — under the MIT License.
> Fredis adaptation: outputs route to `Fredis/Memory/drafts/active/founder-coach/`; advisor-mode — never auto-send.
...
## Fredis Advisor Mode
Output drafts only. Write to `Fredis/Memory/drafts/active/founder-coach/YYYY-MM-DD-<slug>.md`. Never:
