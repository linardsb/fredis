...
description: This skill should be used when the user asks to "design system architecture",
  ...
  system design". Use for architecture decision records (ADRs), tech stack evaluation,
  system design reviews, dependency analysis, and generating architecture diagrams
  in Mermaid, PlantUML, or ASCII format.
---

> Ported from [alirezarezvani/claude-skills](https://github.com/alirezarezvani/claude-skills) — `engineering-team/senior-architect/` — under the MIT License.
> Fredis adaptation: outputs route to `Fredis/Memory/drafts/active/senior-architect/`; advisor-mode — never auto-send.
...
## Fredis Advisor Mode
Output drafts only. Write to `Fredis/Memory/drafts/active/senior-architect/YYYY-MM-DD-<slug>.md`. Never:
